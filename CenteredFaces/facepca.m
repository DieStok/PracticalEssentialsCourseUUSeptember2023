...
%Visualise the dominant eigenvectors.
for ii=1:10
...
%Now add components 5 at a time to build up the two faces. 
%To do this we calculate the component of that face in the direction of each principal component.
%
pause;
for ii=1:30
  subplot(2,2,3)
...
%Plot the proportion of explained variation.
